                                        ...
                                        <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
                                            ...
                                            <div class="grid-demo grid-demo-bg1" style="margin-top: 20px;margin-bottom: 10px;" v-if="newRule == false && ruleBool">
                                                <div class="layui-form-item">
                                                    ...
                                                    <button class="layui-btn layui-btn-sm" type="button" @click="generate">立即生成
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
                                    <div class="grid-demo grid-demo-bg1">
                                        <div class="layui-form-item" v-if="id">
                                            ...
                                            <button class="layui-btn layui-btn-normal" type="button" v-if="layTabId != 3" @click="next">下一步</button>
                                        </div>
                                        <div class="layui-form-item" v-else>
                                            <button class="layui-btn layui-btn-primary" type="button" @click="back" v-if="layTabId != 1">上一步</button>
                                            <button class="layui-btn layui-btn-normal" type="button" @click="next" v-if="layTabId != 3">下一步</button>
